                ...
                <div class="col-sm-4 stx-justify" v-for="(livre) in librairie" v-show="filtre==livre.categorie ||filtre==livre.all">
                    <div class="stx-cards" >
                        ...
                        <div class="stx-cards-entieres">
                            ...
                            <div class="button-contact">
                            <button class="btn btn-warning" v-on:click="ajoutpanier(livre)">acheter</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--partie panier-->
    ...
    methods: {
        ...
        paiement() {
            if (this.nom && this.prenom && this.nomvoie && this.codepost && this.ville && isNaN(this.nom) && isNaN(this.prenom) && isNaN(this.nomvoie) && isNaN(this.ville) && !isNaN(this.codepost) && this.codepost.length == 5) {
                //this.formulaire.push(nom:this.nom,prenom:this.prenom,nomvoie:this.nomvoie,codepost:this.codepost,ville:this.ville)
                this.confirmation = !this.confirmation
                var d = new Date();
                this.date = d.getDate() + '-' + (d.getMonth() + 1) + '-' + d.getFullYear();
                this.datelivr = d.getDate() + 4 + '-' + (d.getMonth() + 1) + '-' + d.getFullYear();
            }
            else { alert("champs mal renseigné !") }
                ...
                <form class="container lex-contact" v-if="isshow">
                    ...
                    <div class="row was-validated justify-content-center">
                        <div class="col-8 mb-3">
                            ...
                            <textarea class="form-control" v-model="message" placeholder="votre commentaire ici"
                            required></textarea>
                            <div class="button-contact">
...
<!--fin formulaire et début message envoyé-->
    ...
    methods: {
        ...
        validform() {
            if (this.nom && this.prenom && this.email && this.telephone && this.message && isNaN(this.nom) && isNaN(this.prenom) && isNaN(this.email) && isNaN(this.message) && !isNaN(this.telephone) && this.telephone.length == 10) {
                //this.formulaire.push(nom:this.nom,prenom:this.prenom,nomvoie:this.nomvoie,codepost:this.codepost,ville:this.ville)
